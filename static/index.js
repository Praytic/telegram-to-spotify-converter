  ...
  <div class="login-split">
    ...
    <div class="login-half">
      <button onclick="loginSpotify()" style="
        ...
        align-items: center;
      ">
        <svg style="width: 27px; height: 30px; margin-top: -6px; margin-left: -12px; margin-right: 5px; margin-bottom: -4px" viewBox="0 0 230 200" xmlns="http://www.w3.org/2000/svg">
